...
public class AdvanceScenario01POM 
{
	...
	static void createUser()
	{
		try
		{
			...
			oPage.getCreateUserEmail().sendKeys("ajaymachani@gmail.com");
			Thread.sleep(2000);
	...
	static void createUser2()
	{
		try
		{
			...
			oPage.getCreateUserEmail().sendKeys("ajaymachani2@gmail.com");
			Thread.sleep(2000);
	...
	static void createUser3()
	{
		try
		{
			...
			oPage.getCreateUserEmail().sendKeys("ajaymachani3@gmail.com");
			Thread.sleep(2000);
